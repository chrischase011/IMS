    ...
    <div id="app">
        <nav class="navbar navbar-expand-lg bg-transparent">
            <div class="container-fluid">
                ...
                <a class="navbar-brand text-wrap text-center fw-bold d-block d-md-none"
                    href="{{ route('index') }}">Century Cardboard Box
                    Factory & Printing
                    Inc.</a>
                                    ...
                                    @if (Auth::user()->roles == 1)
                                        <li class="nav-item dropdown">
                                            ...
                                            <ul class="dropdown-menu " aria-labelledby="navbarDropdown"
                                                ...
                                                <li class="">
                                                    <a class="dropdown-item" href="{{ route('user_log.index') }}">
                                                        <span class="fa fa-note-sticky mr-2" aria-hidden="true"></span>
                                                        User Log
                                                    </a>
                                                </li>
                                            </ul>
